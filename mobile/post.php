...
<?php
    ...
    if(isset($_FILES['image'])){
        ...
        $uid = randomstring(15);
        $sql = "INSERT INTO articles (user_id, title, body, details, new_price, old_price, exp_date,categorie, city, address,postalcode, phone, image_url, uid,percentage_off, redirect_link, sign, counter)
        VALUES ('$user_id','$title', '$body', '$details','$new_price', '$old_price', '$exp_date', '$categorie', '$city', '$address','$postalcode','$phone','$image_url', '$uid','$percentage_off','$redirect_link', '$sign', 0)";
