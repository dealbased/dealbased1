...
<a href="index.php?category=products"><img alt="" name="products" src="Icons/fresh7.svg"><span>Products</span></a> 
<span class="count">(<?php if (isset($categoryCountArray['products'])) echo $categoryCountArray['products']; else echo '0' ?>)</span></li>


<li class="cat-item cat-item-26">
<a href="index.php?category=things_to_do"><img alt="" name="things_to_do" src="Icons/checked27.svg"><span>Things to do</span></a> 
<span class="count">(<?php if (isset($categoryCountArray['things_to_do'])) echo $categoryCountArray['things_to_do']; else echo '0' ?>)</span></li>
...
presence in the marketplace. Like never before, place good looking ads that represent your deals, answer your 
...
<div class="posts-list-wrapper  horizontal-list-4 accent-2-color" style="zoom:0.8;">
<div class="list-header">
          ...
          <?php if (trim($row['new_price']) != '') { ?>
				...
				<div class='regular-price '>
					<span class='amount'>
						...
						<font class="boxUsers" data-user="<?php echo $row['username']?>" 
                            color='green'> <?php echo ($row['status'] == 'Online') ? 'Chat' : $row['status'] ;?> </font>
...
<div class='entry-summary '>
	...
	<?php echo $row['title'];?>.</b>. For more details
