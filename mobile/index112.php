														...
														<div id="woocommerce_product_categories-2" class="widget woocommerce widget_product_categories">
															...
															<ul class="product-categories">
																...
																<li class="cat-item cat-item-37">
																	<a href="index.php?category=electronics"><img alt="" src="Icons/photo-camera2.svg"><span>Electronics</span></a> <span class="count">(<?php if (isset($categoryCountArray['electronics'])) echo $categoryCountArray['electronics']; else echo '0' ?>)</span></li>

																<li class="cat-item cat-item-22">
																	<a href="index.php?category=fashion"><img alt="" src="Icons/picture83.svg"><span>Fashion</span></a> <span class="count">(<?php if (isset($categoryCountArray['fashion'])) echo $categoryCountArray['fashion']; else echo '0' ?>)</span></li>


																<li class="cat-item cat-item-24">
																	<a href="index.php?category=health"><img alt="" name="health" src="Icons/health-care15.svg"><span>Beauty and Health</span></a> <span class="count">(<?php if (isset($categoryCountArray['health'])) echo $categoryCountArray['health']; else echo '0' ?>)</span></li>


																<li class="cat-item cat-item-25">
																	<a href="index.php?category=products"><img alt="" name="products" src="Icons/fresh7.svg"><span>Products</span></a> <span class="count">(<?php if (isset($categoryCountArray['products'])) echo $categoryCountArray['products']; else echo '0' ?>)</span></li>


																<li class="cat-item cat-item-26">
																	<a href="index.php?category=things_to_do"><img alt="" name="things_to_do" src="Icons/checked27.svg"><span>Things to do</span></a> <span class="count">(<?php if (isset($categoryCountArray['things_to_do'])) echo $categoryCountArray['things_to_do']; else echo '0' ?>)</span></li>


																<li class="cat-item cat-item-28">
																	<a href="index.php?category=travel"><img alt="" name="travel" src="Icons/map30.svg"><span>Travel</span></a> <span class="count">(<?php if (isset($categoryCountArray['travel'])) echo $categoryCountArray['travel']; else echo '0' ?>)</span></li>

																<li class="cat-item cat-item-28">
																	<a href="index.php?category=restaurants"><img alt="" name="travel" src="Icons/map30.svg"><span>Restaurants</span></a> <span class="count">(<?php if (isset($categoryCountArray['Restaurants'])) echo $categoryCountArray['Restaurants']; else echo '0' ?>)</span></li>
										...
										<div class="wpb_column vc_column_container vc_col-sm-9">
											<div class="wpb_wrapper">
												<div class="posts-list-wrapper ">
													<div class="posts-list featured-product owl-carousel " data-posts-per-item="1" data-width="900" data-height="340" data-margin="0" data-full-width="yes" data-center="" data-loop="">
														<div class="featured-product post-282 product type-product status-publish has-post-thumbnail product_cat-promo product_cat-travel product_tag-travel location-serbia sale shipping-taxable product-type-external product-cat-promo product-cat-travel product-tag-travel instock">
...
Every business wants to grow and expand, increasing sales year-over-year and staying relevant in the market. Dealbase has created a smart way by which a company can reach customers and maintain a presence in the marketplace. Like never before, place good looking ads that represent your deals, answer your clients online and drive them to your business</div></font>
									...
									<div class="vc_row wpb_row vc_row-fluid container panel">
										<div class="row">
																...
																<div class="wpb_wrapper">
																	<div class="posts-list-wrapper  horizontal-list-3">
																		<div class="list-header">
																			...
																			<div class="posts-list-wrapper  horizontal-list-4 accent-2-color">
																				<div class="list-header">
																					<div class="list-title">
																						<h3>Expiring Soon</h3></div>
																				</div>
																				<div class="posts-list shop-product   horizontal-list-4 accent-2-color" data-posts-per-item="1" data-width="440" data-height="340" data-margin="0" data-full-width="" data-center="" data-loop="">
    ...
    ?>
																									...
																									<div class='entry-thumbnail'>
																										...
																										<a class='inline' href='#inline_content<?php echo $count;?>' name="<?php echo $dbName;?>" onclick="increment('<?php echo $dbName;?>')" href="javascript:void(0);"><span class='purchased' >Share
</span></a>
...
<div class="fb-share-button" data-href="http://dealbase.ca/ContactSeller.php?uid=<?php echo $row['uid']; ?>" data-layout="button_count"></div>
																									...
																									<div class='entry-data'>
																										<div class='entry-header'>
																											...
																											<a class='entry-title ' href='<?php echo $row[' image_url '];?>' title='Xbox One ' style='
    padding-top: 4px;
    padding-bottom: 4px;
...
<span class='currency'>
																													...
																													<font class="boxUsers" data-user="<?php echo $row['username']?>" color='green'><?php echo $row['status'];?></font>
...
<span class='currency '>
																													...
																													<font color='green'><?php echo $row['new_price'];?>$</font>
																													</span>
																												</div>
																											</div>
																										</div>
																										<div class='entry-summary '>
																											<b><?php echo $row['percentage_off'];?>%</b> off
																											<?php echo $row['title'];?>. Get it for only <b><?php echo $row['new_price'];?>$</b>. For more details
																												<a class='inline' href='#inline_content<?php echo $count;?>' name="<?php echo $dbName;?>" onclick="increment('<?php echo $dbName;?>')" href="javascript:void(0);" style='
color:#416CE5; 
border-bottom:1px solid #416CE5;}'>Click here</a>
																												</b>
																		...
																		<tr class="msg-row-container">
																			<td>
																				<div class="msg-row">
																					<div class="avatar"></div>
																					<div class="message">
																						<span class="user-label"><a href="#" style="color: #6D84B4;" class="<?php echo $userchatclass?>" id="<?php echo $row["username"]?>"><?php echo $row["username"]?></a>
...
//														})
													...
													$('.chattitle_minimize').click(function() {
														$(this).closest('.container1').find('.msg-wgt-body').toggle();
														$(this).closest('.container1').find('.msg-wgt-footer').toggle();
...
//														})
//													})
													$('.chattitle_close').click(function() {
														//console.log(this);
